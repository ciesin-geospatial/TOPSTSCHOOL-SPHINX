...
|website-tops| Training program. SCHOOL represents our collective vision to
make science open, inclusive, and accessible to all. By joining SCHOOL, you're
becoming part of a transformative effort to empower learners worldwide. Our
mission is to inspire students, educators, and researchers to leverage NASA
Earth Science Applications and embrace the power of Open Science in solving
some of the world's most pressing challenges. Together, we're building a
global community of learners and innovators.

This page provides a detailed overview of SCHOOL's goals, pedagogy, and the
unique opportunities it offers. We invite you to explore, engage, and
...
At its core, :term:`SCHOOL` is about bridging the gap between cutting-edge
science and practical education. This initiative is part of NASA's Open Source
Science Initiative (OSSI) and focuses on integrating NASA's Earth Science
Applications into the data science life cycle. We have developed a series of
**seven learning modules**, each designed to provide learners with hands-on
experience in applying Open Science principles to real-world problems. These
modules are suitable for both self-led online learning and in-person
instruction, ensuring flexibility and accessibility for diverse audiences.

.. rubric:: Why is SCHOOL Special?
    :heading-level: 3

#. **Thematic Depth.** Each module explores a critical theme affecting our
   planet, including:

   - `Water.`_ Understanding water systems in a changing climate.
   - `Air Quality.`_ Connecting air quality data to public health
     outcomes.
...
The SCHOOL Project represents an ambitious, collaborative journey toward
