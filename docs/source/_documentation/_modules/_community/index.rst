...
.. Created on: Friday, May 23, 2025
.. Last updated on: Friday, May 23, 2025

:og:title: Community Module Introduction
:og:description: Community Module page
...
This section is part of the broader SCHOOL (Science Core Heuristics for Open Science Outcomes in Learning) curriculum within NASA's `Transform to Open Science (TOPS) <https://nasa.github.io/Transform-to-Open-Science/>`__ initiative. These lessons showcase the creativity and applied skills of learners and contributors who have developed use cases around disaster data as part of their journey through open science and the data science life cycle.
...
*   .. button-link:: https://ciesin-geospatial.github.io/TOPSTSCHOOL-community/m501-ejscreen.html
        :color: primary
        :shadow:

        Lesson 501: Exploring EJScreen: Environmental Justice Screening and Mapping Tool 

*   .. button-link:: https://ciesin-geospatial.github.io/TOPSTSCHOOL-community/m502-nasa-acres-climate-resilience-network.html
        :color: primary
        :shadow:
...
*   .. button-link:: https://ciesin-geospatial.github.io/TOPSTSCHOOL-disasters/m504-viirs-wildfires.html
        :color: primary
        :shadow:

        Lesson 504: Mapping Wildfire Burned Areas Using VIIRS AVIRIS-3 Data (Python) 

*   .. button-link:: https://ciesin-geospatial.github.io/TOPSTSCHOOL-disasters/m505-arctic-climate.html
        :color: primary
        :shadow:

        Lesson 505: The Major Effects of Climate Change Towards the Arctic Ecosystem (Python)

*   .. button-link:: https://ciesin-geospatial.github.io/TOPSTSCHOOL-disasters/m506-california-wildfires.html
        :color: primary
        :shadow:

        Lesson 506: Data Analysis of California Wildfires (Python) 

*   .. button-link:: https://ciesin-geospatial.github.io/TOPSTSCHOOL-disasters/m507-snow-storms.html
        :color: primary
        :shadow:
